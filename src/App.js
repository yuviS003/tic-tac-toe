...
import headerImage from "./assets/pngwing.com.png";
import ReactAudioPlayer from "react-audio-player";
import audio from "./assets/bcgAudio/audio-joined-compressed.mp3";
...
function App() {
  ...
  return (
    <div className="App">
      <ReactAudioPlayer src={audio} autoPlay volume={0.05} controls loop/>
